...
namespace QLCuaHangBanXeMayDien.QuanLy_BUS
{
    public class NhanVienBUS
    {
        ...
        public bool InsertNhanvien(string manv, string tennv, int namsinh, string gt, string dt, string diachi, string chucvu, int luong)
        {
        ...
        public bool UpdateNhanVien(string manv, string tennv, int namsinh, string gt, string dt, string diachi, string chucvu, int luong)
        {
